...
class FletXService(ABC):
    ...
    def setup_state_listeners(self):
        ...
        self._state.listen(self.on_state_changed, auto_dispose=False)
    ...
    def on_state_changed(self):
        ...
        # State can be accessed via self._state.value
        pass
    ...
    def __repr__(self) -> str:
        return (
            f"FletXService(name='{self._name}', state={self._state.value}, "
